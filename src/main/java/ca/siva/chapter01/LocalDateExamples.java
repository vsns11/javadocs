...
public class LocalDateExamples {
    ...
    public static void subtractFromDate() {
        ...
        System.out.println("Date after subtracting: " + newDate);
    }
    ...
    public static void createDateWithMonthEnum() {
        ...
        System.out.println("Created Date with Month Enum: " + date);
    }
    ...
    public static void exampleCustomPeriod() {
        ...
        System.out.println("exampleCustomPeriod() " + LocalDate.now().plus(period));
    }
